...
export const blogPosts: BlogPost[] = [
  {
    slug: "score-top-grades-major-exam",
    cover: heroStudent,
    tag: "Exam Guide",
    date: "June 1, 2026",
    title: "How to Score Top Grades in Your Major Exams: The AI-Powered Study Guide",
    metaDescription:
      "A proven 12-week study plan that helps students score top grades in any major exam — diagnosis, targeted practice, mock sprints, and AI-powered revision with Nano Syllabus.",
    excerpt:
      "A proven 12-week system for students targeting top grades in any major exam — from diagnosing your gaps to walking into the exam confident.",
    intro:
    ...
    sections: [
      ...
      {
        heading: "The 5 Study Habits That Separate Top Students",
        paragraphs: [
    ...
    faqs: [
      {
        question: "How early should I start preparing for a major exam?",
        answer:
      ...
      {
        question: "How many months of preparation is enough?",
        answer:
      ...
      {
        question: "Which subjects are usually the hardest?",
        answer:
  ...
  {
    slug: "competitive-entrance-exam-preparation",
    cover: productEntrance,
    tag: "Entrance Guide",
    date: "June 1, 2026",
    title: "Competitive Entrance Exams: The Complete 90-Day Preparation Blueprint",
    metaDescription:
      "A complete 90-day preparation plan for competitive entrance exams — covering the high-weight subjects with month-by-month strategy, common mistakes to avoid, and AI-powered practice with Nano Syllabus.",
    excerpt:
      "The 90-day plan that separates students who clear competitive entrance exams from those who don't — built around the subjects that decide your rank.",
    intro:
    ...
    sections: [
      {
        heading: "Understanding What the Exam Actually Tests",
        paragraphs: [
        ...
        table: {
          headers: ["Subject", "Typical weight", "Why it matters"],
          rows: [
            ["Physics", "High", "Most discriminating; rewards understanding over memory"],
            ["Mathematics", "High", "Speed and accuracy separate top ranks"],
            ["Chemistry", "Medium", "Scoring if you drill reactions and concepts"],
            ["Language / Reasoning", "Lower", "Easy marks most students leave behind"],
          ],
        },
      },
      {
      ...
      {
        heading: "The Common Mistakes That Kill Scores",
        paragraphs: [
      ...
      {
        heading: "How to Use Nano Syllabus for Entrance Prep",
        paragraphs: [
    ...
    faqs: [
      {
        question: "How hard are competitive entrance exams?",
        answer:
      ...
      {
        question: "How many months should I prepare for an entrance exam?",
        answer:
      ...
      {
        question: "Which subject is most important for entrance exams?",
        answer:
      ...
      {
        question: "Can I use AI to prepare for an entrance exam?",
        answer:
  ...
  {
    slug: "crack-any-entrance-exam-in-90-days",
    cover: productEntrance,
    tag: "Guide",
    date: "May 12, 2026",
    title: "How to crack any entrance exam in 90 days",
    excerpt:
  ...
  {
    slug: "a-students-comeback-story",
    cover: aboutStudents,
    tag: "Story",
    date: "April 22, 2026",
    title: "From doubt to breakthrough: a student's story",
    excerpt:
  ...
  {
    slug: "physics-chapters-that-matter",
    cover: productStudy,
    tag: "Physics",
    date: "April 11, 2026",
    title: "Physics: the chapters that actually matter",
    excerpt:
  ...
  },
  {
    ...
    excerpt:
      "How we shaped explanations to feel relevant, patient, and actually useful for students everywhere.",
    intro:
    ...
    sections: [
      {
        heading: "Curriculum context changes what a good answer looks like",
        paragraphs: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Students everywhere face the same challenge: a single teacher managing thirty or forty students in a classroom cannot give each one the individualized attention they need. Students preparing for competitive entrance exams often rely on the same notes, the same coaching materials, and the same schedule — regardless of their individual weak points.",
      ...
      },
      {
        ...
        paragraphs: [
          "Nano Syllabus is an AI co-pilot that learns each student's exact curriculum — the syllabus, entrance exam question banks, and teacher notes — so the explanations and practice it generates are directly relevant to what students are actually studying.",
          "When a student opens Nano Syllabus, they do not get a generic AI chatbot. They get a system that understands what their textbook chapter covers, knows which question types appear most on their exam, and can explain a concept the way a good teacher would — with familiar examples and clear academic context.",
    ...
    faqs: [
      ...
      {
        question: "How does Nano Syllabus personalize learning?",
        answer:
          "Nano Syllabus is built around each student's official curriculum and exam materials. When a student asks a question or requests practice, the AI generates content aligned to their syllabus and exam patterns — not generic content. This makes it directly useful for coursework and entrance exam preparation alike.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Nano Syllabus covers core school and pre-university subjects — Physics, Chemistry, Mathematics, Biology, and Computer Science — as well as entrance exam preparation materials, all aligned to your own syllabus.",
      },
    ],
  },
  {
    ...
    excerpt:
      "Comparing the major AI-powered learning platforms available to students in 2026, with particular attention to what matters most: how well each tool fits your own syllabus and exam.",
    intro:
    ...
    faqs: [
      {
        question: "What is the best AI learning platform for students?",
        answer:
